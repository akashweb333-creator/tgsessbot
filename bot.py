...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle button callbacks - COMPLETE FIXED VERSION"""
    ...
    # ============================================
    # Skip handlers for other modules
    # ============================================
    if query.data.startswith('admin_'):
        return
    if query.data.startswith('leader_'):
        return
    if query.data.startswith('seller_'):
        return
    if query.data.startswith('ref_withdraw_'):
        return
    ...
    # ============================================
    # ✅ REFERRAL HANDLERS - FIXED ORDER
    # MUST BE FIRST, BEFORE ALL OTHER HANDLERS
    # ============================================
    ...
    if query.data == 'referral_history':
        ...
        try:
            ...
            traceback.print_exc()
            await query.edit_message_text(
                f"❌ Error loading referral history.\n\nError: {str(e)}\n\nPlease contact support."
            )
        return
    
    if query.data == 'referral_withdraw':
        logger.info(f"   → Skipping: Referral withdraw (ConversationHandler)")
    ...
    # Let ConversationHandlers catch these
    # ============================================
    ...
    # ============================================
    # 📱 WHATSAPP HANDLERS (BEFORE MAIN MENU)
    # ============================================
    ...
    elif query.data.startswith('refund_confirm_'):
    ...
    # ============================================
        ...
        # This is handled by seller.py handlers
        pass
    
    # ============================================
    # UNHANDLED CALLBACKS (DEBUG)
    # ============================================
    else:
...
def main():
    """Start the bot - COMPLETE FINAL VERSION"""
    # ============================================
    # START WEB SERVER
    # ============================================
    keep_alive()
    ...
    logger.info("✅ Deposit conversation registered")
    ...
    logger.info("✅ Bulk custom conversation registered")
    
    # ============================================
    # SETUP MODULE HANDLERS (ORDER MATTERS!)
    # ============================================
    ...
    # 4. ✅ REFERRAL HANDLERS (CRITICAL - MUST BE BEFORE MAIN CALLBACK)
    # This registers:
    # - Referral withdrawal ConversationHandler
    # - Referral admin approval callbacks
    # - Other referral-specific handlers
    try:
    ...
    # These have specific patterns and should be registered before main callback
    # ============================================
    ...
    logger.info("✅ Specific callback handlers registered")
    
    # ============================================
    # ✅ MAIN CALLBACK HANDLER (LAST, GROUP=1)
    # This catches ALL remaining callbacks that weren't caught by specific handlers
    # MUST be registered AFTER all other handlers
    # ============================================
    application.add_handler(CallbackQueryHandler(button_callback), group=1)
    logger.info("✅ Main callback handler registered (group=1)")
